...
export const projects: ProjectData[] = [
  ...
  },
  {
    ...
    desc: 'A real-time atmospheric scattering renderer supporting hot-swapping of atmosphere presets and parameters, built to explore physically based sky and planetary rendering techniques. This is an older project that uses deprecated URP APIs.',
    stack: ['Unity', 'HLSL', 'Real-Time Rendering'],
    href: 'https:/github.com/privateDuck/atmospheric-scattering',
    featured: false,
  },
  {
    domain: 'Graphics',
    ...
    statusType: 'completed',
    name: '2D FFT Solver',
    desc: 'A 2D FFT/IFFT Solver written using compute shaders for unity. Written mainly for the older built-in render pipeline.',
    stack: ['Unity', 'HLSL'],
    href: 'https://github.com/privateDuck/G2D-FFT',
    featured: false,
  },
  {
    domain: 'Data Systems',
